...
const DEFAULT_BASIC_INFO: ISchema<IBasicInfoProps> = {
  id: "-1",
  componentKey: "BasicInfo",
  blockName: "基本信息",
  props: {
...
const DEFAULT_PROFESSIONAL_SKILL: ISchema<IProfessionalSkillProps> = {
  id: "-2",
  componentKey: "ProfessionalSkill",
  blockName: "专业技能",
  props: {
...
const DEFAULT_PROJECT_EXPERIENCE: ISchema<IProjectExperienceProps> = {
  id: "-3",
  componentKey: "ProjectExperience",
  blockName: "项目经验",
  props: {
...
const DEFAULT_WORK_EXPERIENCE: ISchema<IProjectExperienceProps> = {
  id: "-3",
  componentKey: "ProjectExperience",
  blockName: "项目经验",
  props: {
...
const DEFAULT_EDUCATION_EXPERIENCE: ISchema<IProjectExperienceProps> = {
  id: "-3",
  componentKey: "ProjectExperience",
  blockName: "项目经验",
  props: {
...
/** 默认自定义板块数据 */
const DEFAULT_CUSTOM_BLOCK_TEMPLATE = {
  id: "-3",
  componentKey: "ProjectExperience",
  blockName: "自定义",
  props: {
